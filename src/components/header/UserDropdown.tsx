...
import { logoutInstructor } from "@/app/actions/authActions";
...
// If no session, show placeholder but still render
...
const displayEmail = session?.email || "Not logged in";
  return (
    <div className="relative">
      ...
      >
        <div className="flex items-center justify-center w-11 h-11 mr-3 font-semibold text-white rounded-full bg-brand-500">
